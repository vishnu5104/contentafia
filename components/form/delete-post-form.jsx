...
export default function DeletePostForm({ postName }) {
    const { id } = useParams();
    const router = useRouter();
    return (<form action={async (data) => window.confirm("Are you sure you want to delete your post?") &&
